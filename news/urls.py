...
from .views import NewsList, NewDetail, create_new, NewDelete, NewUpdate, ArticleDelete, ArticleCreate, ArticleUpdate, HomePage
...
urlpatterns = [
    ...
    path('home/', cache_page(60*1)(HomePage.as_view()), name='homepage')
]